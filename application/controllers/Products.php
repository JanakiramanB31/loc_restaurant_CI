...
class Products extends Admin_Controller 
{
    ...
    */
    ...
    public function fetchProductDataByCategory($id)
	{
        if(!in_array('viewProduct', $this->permission)) {
            redirect('dashboard', 'refresh');
        }
        ...
        if ($id == 0) {
		    ...
		    $data = $this->model_products->getProductDataByCat($id);
        }
    ...
    */
	public function create()
	{
		...
		$this->form_validation->set_rules('category[]', 'Category', 'trim|required', array(
			'required' => 'Please select at least one category for the product.'
		));
