      ...
      <div class="ibox float-e-margins">
        <div class="ibox-content">
          ...
          <div class="print-header" style="width: 100%;">
            <h3><span style="text-align: center;" class="boldfont">X Report</span></h3>
...
<div class="hidden-print" style="margin-left:10px; text-align: center; width: <?php echo $paperWidth; ?>;">
  ...
  <button><a class="btn btn-primary nextbutton" style="text-decoration: none;color: #000;" href="<?php echo base_url('x_report'); ?>"><i class="fa fa-plus"></i> Close</a></button>
</div>
...
<script>
  $(document).ready(function () {
    ...
    function printDiv() {
      ...
      printWindow.document.write('<html><head><title>X-Report Print</title>');
