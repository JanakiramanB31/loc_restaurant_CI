<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php /*echo '<pre>'; print_r($user_permission);*/ if($user_permission): ?>
        ...
        <?php if(in_array('createProduct', $user_permission) || in_array('updateProduct', $user_permission) || in_array('viewProduct', $user_permission) || in_array('deleteProduct', $user_permission)): ?>
         ...
         <!--  <?php if(in_array('createOrder', $user_permission) || in_array('updateOrder', $user_permission) || in_array('viewOrder', $user_permission) || in_array('deleteOrder', $user_permission)): ?>
          ...
          <?php if(in_array('createOrder', $user_permission) || in_array('updateOrder', $user_permission) || in_array('viewOrder', $user_permission) || in_array('deleteOrder', $user_permission)): ?>
            <li class="treeview" id="POSOrderMainNav">
              <a href="#">
                <i class="fa fa-clipboard"></i>
              ...
              <ul class="treeview-menu">
                <?php if(in_array('createOrder', $user_permission)): ?>
                  <li id="createPOSOrderSubMenu"><a href="<?php echo base_url('pos_orders/create') ?>"><i class="fa fa-circle-o"></i> Add POS Order</a></li>
                <?php endif; ?>
                <?php if(in_array('updateOrder', $user_permission) || in_array('viewOrder', $user_permission) || in_array('deleteOrder', $user_permission)): ?>
                <li id="managePOSOrderSubMenu"><a href="<?php echo base_url('pos_orders') ?>"><i class="fa fa-circle-o"></i> Manage POS Orders</a></li>
                <?php endif; ?>
              </ul>
            </li>
          <?php endif; ?>
            ...
            <li class="treeview" id="ReportMainNav">
              ...
              <ul class="treeview-menu">
                <?php if(in_array('viewReport', $user_permission)): ?>
                  ...
                  <li id="xReportSubMenu"><a href="<?php echo base_url('x_report') ?>"><i class="fa fa-circle-o"></i> X-Report</a></li>
                  <li id="zReportSubMenu"><a href="<?php echo base_url('z_report') ?>"><i class="fa fa-circle-o"></i> Z-Report</a></li>
